...
import {device as d, Tw2BasicPerObjectData} from '../../core';
...
export class EveTransform extends EveObject
{
    constructor()
    {
        ...
        this._perObjectData = new Tw2BasicPerObjectData(EveTransform.perObjectDataDecl);
...
EveTransform.perObjectDataDecl = {
    FFEData: [
        {name: 'World', size: 16},
        {name: 'WorldInverseTranspose', size: 16}
    ]
};