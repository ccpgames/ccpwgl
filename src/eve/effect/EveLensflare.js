...
import {device as d, store, Tw2TextureRes, Tw2RenderTarget} from '../../core';
...
export class EveLensflare
{
    ...
    UpdateOccluders()
    {
        ...
        vec3.set(store.GetVariable('LensflareFxOccScale').value, this.occlusionIntensity, this.occlusionIntensity, 0, 0);
    ...
    GetBatches(mode, accumulator, perObjectData)
    {
        if (this.display)
        {
            ...
            vec4.transformMat4(viewDir, viewDir, d.viewInverse);
    ...
    PrepareRender()
    {
        ...
        vec3.transformMat4(cameraPos, [ 0, 0, 0 ], d.viewInverse);
        ...
        vec4.transformMat4(viewDir, [ 0, 0, 1, 0 ], d.viewInverse);
        ...
        vec4.set(store.GetVariable('LensflareFxDirectionScale').value, dir[0], dir[1], dir[2], 1);
        vec4.set(dist, dir[0], dir[1], dir[2], 0);
        vec4.transformMat4(dist, dist, d.view);
        vec4.transformMat4(dist, dist, d.projection);
        dist[0] /= dist[3];
        dist[1] /= dist[3];
