import {util, vec2, vec4} from '../../math';
 ...
 * @returns {boolean}
 */
Tw2Vector4Parameter.prototype.EqualsValue = function(value)
{
    return vec4.equals(this.value, value);
};
...
{
    return util.isArrayLike(value) && value.length === 4;
};
